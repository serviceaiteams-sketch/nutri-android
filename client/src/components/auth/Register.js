...
import { FaEye, FaEyeSlash, FaUser, FaEnvelope, FaLock, FaWeight, FaRuler, FaBirthdayCake, FaVenusMars } from 'react-icons/fa';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (success) {
        toast.success('Registration successful! Welcome to NutriAI!');
        navigate('/dashboard');
      }
    } catch (error) {
